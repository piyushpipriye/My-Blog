...
if(isset($_POST["Submit"])){
	...
	elseif(strlen($title)<2){
		...
		$id=$_GET['Edit'];
		global $conn;
		$query  = "UPDATE admin SET datetime='$datetime',title='$title',
		category='$category',author='$admin',images='$image',post='$post' WHERE id='$id'";
...
<div>
	...
	?>
<form action="editpost.php?Edit=<?php echo $search;?>" method="post" enctype="multipart/form-data">
<fieldset>
<div class="form-group">
<label for="title"><span class="fieldinfo">Enter Title:</span></label>
<input class="form-control" type="text" name="title" id="title" placeholder="Enter Title" value="<?php echo$title; ?>">
</div>
<div class="form-group">
